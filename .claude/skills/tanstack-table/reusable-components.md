...
```tsx
import { Button, Menu, MenuItem, MenuTrigger, Popover } from '@oakoss/ui';
...
```tsx
import { Button, Select, SelectItem } from '@oakoss/ui';
...
- Access original data via `row.original`
- Only import row models you use
- Each table is unique - don't over-abstract
